...
function SuperAdminProductListingPage() {
   ...
   useEffect(()=>{
    ...
    if(!productFetchRef.current){
      ...
      // console.log("fetchadminproductsVoidbefore" ,fetchAllProductsForAdmin());      // this returns nothing, because Promise<void> initially, and after fulfilling the async request, it will log into the "products"
  ...
  return (
    <div className='p-6'>
      ...
      <header className='flex items-center justify-between'>
            <h1>All Products</h1>
            <Button onClick={()=> router.push('/super-admin/products/add')} >Add New Product</Button>
     </header>
              ...
              <TableRow
                ...
                <TableCell>
                  <div className='flex items-center gap-3'>
                    <div className='rounded-log bg-gray-100 overflow-hidden'>
                      {
                        product.images[0] && (
                          <Image
                    ...
                    <div>
                      ...
                      <p className='text-sm text-muted-foreground'> Size: {product.sizes.join(',')} </p>
                    </div>
                  </div>
                </TableCell>
...
// if no products found, then we can also add a message "no product found"
